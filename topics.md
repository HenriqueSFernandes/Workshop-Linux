...
3. Introdução à criação de arquivos (mkdir, touch, rm, mv, cp, etc)
...
Certamente que uma das primeiras coisas que vos passa pela cabeça ao pensar em usar um terminal é "porquê perder tempo a aprender comandos se podemos fazer tudo através de uma interface gráfica?". 